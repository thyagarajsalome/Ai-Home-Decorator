...
const PricingClient: React.FC<{ country: string }> = ({ country }) => {
  const creditPacks = country === "US" ? usPacks : inPacks;
  ...
  const handlePurchase = async (pack: CreditPack) => {
    ...
    try {
      ...
      const orderResponse = await fetch(`/api/create-order`, {
        ...
        body: JSON.stringify({ packId: pack.priceId, country }),
      });
