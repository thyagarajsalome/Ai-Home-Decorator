        ...
        <div className="space-y-8 text-gray-300 leading-relaxed text-sm md:text-base">
          ...
          <div>
            ...
            <p>
              ...
              <Link to="/policy" className="text-purple-400 hover:text-purple-300 font-semibold transition-colors hover:underline">
                Privacy Policy
              </Link>{" "}
              and{" "}
              <Link to="/disclaimer" className="text-purple-400 hover:text-purple-300 font-semibold transition-colors hover:underline">
                Disclaimer
              </Link>
